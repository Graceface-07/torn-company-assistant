...
# Target relative to /scripts directory
target_dir = os.path.normpath(os.path.join(os.path.dirname(__file__), "..", "docs", "decision_flow"))
os.makedirs(target_dir, exist_ok=True)

file_path = os.path.join(target_dir, "company_ownership.md")
content = """# Buying or Starring a Company
...
print(f"✅ company_ownership.md created at: {file_path}")
